...
namespace System.Reflection.Metadata
{
    public static partial class AssemblyExtensions
    {
        ...
        internal static unsafe void ApplyUpdateInternal(RuntimeAssembly runtimeAssembly, ReadOnlySpan<byte> metadataDelta, ReadOnlySpan<byte> ilDelta, ReadOnlySpan<byte> pdbDelta)
        {
            RuntimeAssembly rtAsm = runtimeAssembly;
